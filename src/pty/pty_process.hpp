 ...
 *
 * Implemented with `forkpty()` (Linux and MSYS2). The operator's real
 * terminal (fd 0) is switched to raw mode for the lifetime of this object
 * and restored on destruction.
 */
class pty_process {
 public:
  /**
